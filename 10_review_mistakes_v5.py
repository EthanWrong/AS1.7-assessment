...
# user_mistakes = [{'question': 'tekau', 'answers': ['ten', '10'], 'user_answer':'0'},
#                  {'question': 'whitu', 'answers': ['seven', '7'], 'user_answer':'0'},
#                  {'question': 'whitu', 'answers': ['seven', '7'], 'user_answer':'5'},
#                  {'question': 'whitu', 'answers': ['seven', '7'], 'user_answer':'6'},
#                  {'question': 'tekau', 'answers': ['ten', '10'], 'user_answer':'twenty'},
#                  {'question': 'five', 'answers': ['rima'], 'user_answer':'fifty'}]
